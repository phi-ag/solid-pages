// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: bffb979dbcb13e33658a9a8ff97962a5)
// Runtime types generated with workerd@1.20250321.0 2024-11-03 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		ENVIRONMENT: "preview" | "production";
		DOMAIN: "preview-solid-pages.phi.ag" | "solid-pages.phi.ag";
